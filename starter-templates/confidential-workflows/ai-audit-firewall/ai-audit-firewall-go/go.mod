...
// (cre.HandlerInTee / cre.TeeRuntime). The capabilities/networking/http,
// capabilities/scheduler/cron, and capabilities/blockchain/evm submodules have not
// had a tagged release since v1.18.0 shipped, so they're pinned via pseudo-version
// to the same commit.
//
