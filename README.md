...
- **`building-blocks/solana-read-write`** – Write a key/value report to a **Solana** program via the keystone forwarder, then read it back directly, on a cron schedule; includes an Anchor receiver program and deploy instructions.
