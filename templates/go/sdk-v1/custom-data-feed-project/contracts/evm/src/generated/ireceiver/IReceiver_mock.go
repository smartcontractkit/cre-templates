...
// IReceiverMock is a mock implementation of IReceiver for testing.
type IReceiverMock struct {
	SupportsInterface func(SupportsInterfaceInput) (bool, error)
}

// NewIReceiverMock creates a new IReceiverMock for testing.
func NewIReceiverMock(address common.Address, clientMock *evmmock.ClientCapability) *IReceiverMock {
	mock := &IReceiverMock{}
